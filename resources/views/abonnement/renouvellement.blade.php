...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
    <div>
        <h1 class="h2 text-dark fw-bold d-flex align-items-center gap-2">
            <i class="bi bi-arrow-repeat"></i> Renouvellement d'abonnement
        </h1>
        <p class="text-muted mb-0">Renouvelez votre accès pour continuer à utiliser votre boutique</p>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
        ...
        @if(isset($ancienAbonnement) && $ancienAbonnement->date_fin)
        <div class="alert border-0 shadow-sm d-flex align-items-center gap-2 mb-4" style="background:#FEF3C7;border-radius:12px;">
            ...
            <span>Votre abonnement a expiré le
                <strong>{{ $ancienAbonnement->date_fin->format('d/m/Y') }}</strong>.
